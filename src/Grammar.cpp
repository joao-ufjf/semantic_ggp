...
void Grammar::makeTerminals() {
    ...
    bynaryArithmeticOperators.push_back("+"); // 0
    bynaryArithmeticOperators.push_back("-"); // 1
    bynaryArithmeticOperators.push_back("*"); // 2
    bynaryArithmeticOperators.push_back("/"); // 3
    bynaryArithmeticOperators.push_back("^"); // 4
    bynaryArithmeticOperators.push_back("."); // 5 // float point
    bynaryArithmeticOperators.push_back("<I2"); // 6 // float point fractional aggregator
    bynaryArithmeticOperators.push_back("<D2"); // 7 // float point fractional aggregator
    ...
    unaryArithmeticOperators.push_back("log"); // 0
    unaryArithmeticOperators.push_back("exp"); // 1
    unaryArithmeticOperators.push_back("sqrt"); // 2
    unaryArithmeticOperators.push_back("cos"); // 3
    unaryArithmeticOperators.push_back("sin"); // 4
    unaryArithmeticOperators.push_back("tan"); // 5
    unaryArithmeticOperators.push_back("acos"); // 6
    unaryArithmeticOperators.push_back("asin"); // 7
    unaryArithmeticOperators.push_back("atan"); // 8
    unaryArithmeticOperators.push_back("cosh"); // 9
    unaryArithmeticOperators.push_back("sinh"); // 10
    unaryArithmeticOperators.push_back("tanh"); // 11
    unaryArithmeticOperators.push_back("int"); // 12
    unaryArithmeticOperators.push_back("<I1"); // 13 // float point fractional aggregator
    unaryArithmeticOperators.push_back("<D1"); // 14 // float point fractional aggregator
    ...
    //10
    vector<string> declare_variable;
    declare_variable.push_back("<-");
    terminals.push_back(declare_variable);
    conf->declare_variable = terminals.size() - 1;
    //10
    vector<string> use_variable;
    use_variable.push_back("f()");
    terminals.push_back(use_variable);
    conf->use_variable = terminals.size() - 1;
    //11
    vector<string> hill_cube;
    hill_cube.push_back("hill_cube");
    terminals.push_back(hill_cube);
    conf->hill_cube = terminals.size() - 1;
}
...
//    cout << n->mask << endl;
    if(n->type == NONTERMINAL) {
        ...
        if(i == 0) {
            ...
            cout << "n->print(0);" << endl;
            n->print(0);
            cout << "height deep" << endl;
            cout << n->height << " " << n->deep << endl;
            cout << "ALTURA MÍNIMA DE ÁRVORE EXCEPTION" << endl;
            cout << 0/0 << endl;
            exit(43);
        }
